...
Omar.deposit(1000).deposit(800).deposit(120).withdraw(1200).display_account_info()

#To the second account, make 2 deposits and 4 withdrawals, then yield interest and display the account's info
Emy.deposit(800).deposit(900).withdraw(120).withdraw(1000).withdraw(200).withdraw(150).display_account_info()
